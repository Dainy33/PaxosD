...
public class PaxosKVServer1 {
    ...
    public PaxosKVServer1(String confFile) {
    ...
    public static void main(String[] args) {
        String confFile = Paths.get(System.getProperty("user.dir"),"/example/conf/server1.json").toString();
        PaxosKVServer1 server = new PaxosKVServer1(confFile);
        server.init();
        server.startServer();
    }
}
